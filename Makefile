...
PROJECT_REPO ?= github.com/Laubi/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/dynatrace-oss/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
...
xpkg.build.provider-dynatrace: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/dynatraces/01-delete.yaml.tmpl.
